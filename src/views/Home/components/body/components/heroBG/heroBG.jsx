      ...
      <div className="hero__background row">
        <div className="heroBg__wrap row">
          ...
          <div className="heroBg__des row">
            <p>lancer Technologies is a sofware company that develops, innovativeand creative products and services that provide total cation and information solutions. Among a cyber security
